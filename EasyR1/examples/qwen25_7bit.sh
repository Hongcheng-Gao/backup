...
MODEL_PATH=/mnt/workspace/gaohongcheng/verl/models/Qwen2.5-7B  # replace it with your local file path

python3 -m verl.trainer.main \
    config=examples/config.yaml \
    data.train_files=/mnt/workspace/ghc/data/datasets/7bit/train.parquet \
    data.val_files=/mnt/workspace/ghc/data/datasets/7bit/test.parquet \
    ...
    trainer.experiment_name=Qwen2.5-7B_7bit_dapo \
